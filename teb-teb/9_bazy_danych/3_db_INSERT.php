...
USER;
      ...
      if (isset($_GET['adduser'])) {
        ...
        <br><input type=text placeholder=Miasto name=city_id /><br>
        ...
        echo "<a href='./3_db_INSERT.php?adduser='><h1>DODAJ UŻYTKOWNIKA</h1></a>";
      }

     ?>
  <form class="" action="./skrypty/insert.php" method="post">
